<section>
    ...
    <form method="post" action="{{ route('password.update') }}" class="mt-6 space-y-6">
        ...
        <div>
            ...
            <x-text-input id="update_password_current_password" name="current_password" type="password" class="mt-1 block w-full border-green-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" autocomplete="current-password" />
        ...
        <div>
            ...
            <x-text-input id="update_password_password" name="password" type="password" class="mt-1 block w-full border-green-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" autocomplete="new-password" />
        ...
        <div>
            ...
            <x-text-input id="update_password_password_confirmation" name="password_confirmation" type="password" class="mt-1 block w-full border-green-300 focus:border-green-500 focus:ring-green-500 rounded-md shadow-sm" autocomplete="new-password" />
